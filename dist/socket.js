...
exports.connectSocket = function (server) {
    ...
    io.on("connection", function (socket) {
        socket.on("joinRoom", function (data) { return __awaiter(void 0, void 0, void 0, function () {
            var room, user, socketId, activeUsers;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        socket.join(room);
                        socketId = socket.id;
                        return [4 /*yield*/, users_1.addUserToRoom(user.userId, socketId, room)];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        socket.on("messageFromClient", function (message) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, messages_1.addNewMessage(message, room)];
                                    case 1:
                                        newMessage = _a.sent();
